...
# Exported @ Thu May 07 08:46:51 PDT 2015
...
send FRCGROUP:CREATE -g ARMY -longname {Elitian Army} -a GOV -color #3B61FF -forcetype REGULAR -training FULL -equip_level GOOD -base_personnel 20000 -demeanor AVERAGE -cost 0.00 -local 1
send FRCGROUP:CREATE -g PELFM -longname {PELF Militia} -a PELF -color #3B61FF -forcetype IRREGULAR -training FULL -equip_level GOOD -base_personnel 6000 -demeanor AGGRESSIVE -cost 1,000.00 -local 1
