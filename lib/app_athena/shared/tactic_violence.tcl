...
#
# DESCRIPTION:
#    athena_sim(1): Mark II Tactic, VIOLENCE event
#
...
tactic define VIOLENCE "Violence Event" {system actor} {
    #-------------------------------------------------------------------
    # Instance Variables
...
order define TACTIC:VIOLENCE {
    title "Tactic: Violence Event"
    ...
    prepare tactic_id  -required -with {::strategy valclass tactic::VIOLENCE}
    returnOnError
