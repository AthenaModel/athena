...
package provide athena 6.4.0a1
# -kite-provide-end
...
source [file join $::athena::library vardiffs vardiff_personnel.tcl  ]
source [file join $::athena::library vardiffs vardiff_population.tcl ]
source [file join $::athena::library vardiffs vardiff_sat.tcl        ]
source [file join $::athena::library vardiffs vardiff_saliency.tcl   ]
source [file join $::athena::library vardiffs vardiff_security.tcl   ]
