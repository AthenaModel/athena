...
snit::type ::athena::demog {
    ...
    #-------------------------------------------------------------------
    # Assessment of demographic situations.

    # assess 
    #
    # Assesses the attitude effects of all demographic situations.
    ...
    # AssessCONSUMP
    #
    # Assesses all CONSUMP situations.

    method AssessCONSUMP {} {
        ...
        $adb eval {
            ...
            $adb ruleset CONSUMP assess $fdict
        }
    }
