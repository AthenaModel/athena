...
proc Cgi_Directory {virtual {directory {}}} {
	...
	set directory [::ahttpd::doc virtual {} {} $virtual]
    }
    ::ahttpd::doc registerroot $virtual $directory
...
proc Cgi_SetEnvAll {sock path extra url var} {
    ...
    set env(PATH_TRANSLATED) [string trimright [::ahttpd::doc root] /]/[string trimleft $data(url) /]
    set env(DOCUMENT_ROOT) [::ahttpd::doc root]
    set env(HOME) [::ahttpd::doc root]
