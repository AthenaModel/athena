...
oo::class create /scenario {
    ...
    method NbhoodHistHtml {case var args} {
        set concerns 0
    ...
    # NbhoodGroupHistHtml case var ?args?
    #
    # case    - an Arachne case
    ...
    method NbhoodGroupHistHtml {case var args} {
        # FIRST get the options
        set gtypes {CIV FRC ORG}
    ...
    method NbhoodActorHistHtml {case var} {
        my HistoryBanner $case $var
    ...
    method GroupHistHtml {case var args} {
        # FIRST get the options
        set gtypes   {CIV FRC ORG}
        set concerns 0
    ...
    method GroupsHistHtml {case var args} {
    ...
    method UnsupportedHistHtml {case var} {
        my HistoryBanner $case $var
    ...
    method NbhoodHistJson {case var args} {
        set concerns 0
    ...
    # NbhoodGroupHistJson case var args
    #
    # case   - an Arachne case
    ...
    method NbhoodGroupHistJson {case var args} {
        # FIRST get the options
        set gtypes {CIV FRC ORG}
    ...
    # NbhoodActorHistJson case var args
    #
    # case   - an Arachne case
    ...
    method NbhoodActorHistJson {case var} {
        set actors [list  ALL {*}[case with $case actor names]]
        set a [qdict prepare a -toupper -default ALL -in $actors]
    ...
    method GroupHistJson {case var args} {
        # FIRST get the options
        set gtypes   {CIV FRC ORG}
        set concerns 0
    ...
    method GroupsHistJson {case var args} {
        # FIRST get the options
        set gtypes1 {CIV FRC ORG}
        set gtypes2 {CIV FRC ORG}
    ...
    method JSONQuery {case var keys} {
        ...
        # NEXT, build up file name for JSON output
        append fname $case "_" $var "_"

        # NEXT, values for where clause, extending file name as we go
        set wlist [list]
        ...
        my redirect "/[file tail $filename]" 
    }
